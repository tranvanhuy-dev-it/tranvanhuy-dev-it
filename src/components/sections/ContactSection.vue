<template>
  <section id="contact" class="relative py-24 px-4 overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto relative z-10">
      <SectionTitle :title="store.ui.contactTitle || 'Contact'" :subtitle="store.ui.contactSubtitle || 'Get In Touch'"
        :description="store.ui.contactDesc || 'Let\'s connect to discuss job opportunities or collaboration!'" />
...
const contactItems = [
  ...
  { label: 'Location', type: 'location', value: store.personal.location, href: null },
  { label: 'Status', type: 'status', value: store.personal.availability, href: null },
]
