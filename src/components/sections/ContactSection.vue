          ...
          <div class="pt-4 border-t border-slate-800/80 light:border-slate-200">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
              <a
                ...
                target="_blank"
                rel="noopener"
                class="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-slate-850 hover:bg-slate-750 text-slate-200 hover:text-white border border-slate-700/80 text-xs font-medium transition-all shadow-sm whitespace-nowrap"
              >
              ...
              <a
                ...
                class="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-slate-850 hover:bg-slate-750 text-slate-200 hover:text-white border border-slate-700/80 text-xs font-medium transition-all shadow-sm whitespace-nowrap"
              >
                <IconGithub class="w-4 h-4 fill-current text-slate-300 shrink-0" />
                <span>GitHub</span>
              </a>
              ...
              <a
                ...
                download
                class="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-300 hover:text-cyan-200 border border-cyan-500/30 text-xs font-semibold transition-all shadow-sm whitespace-nowrap"
              >
