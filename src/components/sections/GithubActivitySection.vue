  ...
  <div class="mt-12 sm:mt-16 pt-10 border-t border-slate-800/80 light:border-slate-200">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6 sm:mb-8">
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        class="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-850 hover:bg-slate-800 light:bg-slate-100 light:hover:bg-slate-200 text-slate-200 hover:text-white light:text-slate-800 border border-slate-700/80 light:border-slate-300 text-xs font-mono transition-all group shrink-0"
      >
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
      ...
      <div class="p-4 rounded-2xl bg-slate-850/80 light:bg-slate-50 border border-slate-800 light:border-slate-200 shadow-sm">
        <div class="text-[10px] sm:text-xs font-mono uppercase tracking-wider text-slate-400">Community</div>
        <div class="text-2xl sm:text-3xl font-extrabold text-purple-400 mt-1 font-mono">
          {{ stats.followers }} <span class="text-xs text-slate-400 font-sans font-normal">Followers</span>
        </div>
      </div>
    </div>
