<template>
  <div class="mb-3.5 sm:mb-8 text-left fade-up">
    ...
    <p v-if="description" class="text-slate-400 light:text-slate-600 mt-1 sm:mt-2 text-xs sm:text-sm max-w-2xl leading-relaxed">
      {{ description }}
    </p>
  </div>
</template>
